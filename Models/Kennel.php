...
class Kennel extends Product
{
    ...
    public function __construct(string $_name, array $_categories, float $_price, string $_description, string $_material, float $_width, float $_height, float $_depth, string $_imgUrl = '')
    {
